...
def TextToIcon(Text, TemplateImage, Font, FilePath, CourseSeed):
    ...
    draw.ellipse( # draw the main circle 
        ...
        fill = (randint(0,255),randint(0,255),randint(0,255)),  # random colour for the circle
...
def AddTextToImageAndDealWithString(Text, OutputFile, Year, CouseNumber):
    ...
    TextToIcon(StringForImage+Year, "Template.png", "fonts/Haim new.ttf", OutputFile, CouseNumber)
